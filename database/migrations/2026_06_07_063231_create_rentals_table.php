...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('rentals', function (Blueprint $table) {
            ...
            $table->foreignUlid('customer_id')->constrained()->cascadeOnUpdate()->restrictOnDelete();
            ...
            $table->foreignUlid('picked_up_by')->nullable()->constrained('users')->cascadeOnUpdate()->nullOnDelete();
            $table->foreignUlid('returned_by')->nullable()->constrained('users')->cascadeOnUpdate()->nullOnDelete();
            $table->timestamps();
